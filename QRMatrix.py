# Credits
# This class is originally taken from the project referenced below. The class was modified for the needs of my project.
# For the original version and project please follow the links below:
# GitHub user: yoshikimiki (https://github.com/yoshikimiki)
# GitHub project: Python-QR-Decoder (https://github.com/yoshikimiki/Python-QR-Decoder)
# GitHub file: QRMatrix.py
